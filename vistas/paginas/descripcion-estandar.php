...
<section class="w3l-about-breadcrum b baner-azul">
    <div class="breadcrumb-bg breadcrumb-bg-services py-5">
        <div class="container py-lg-4 py-md-3">
            <h2 class="title">Cuenta Estandar</h2>
            <ul class="breadcrumbs-custom-path">

                <!-- <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span> Cuenta Estandar</li>-->
            </ul>
        </div>
    </div>
</section>
            ...
            <div class="grids-area-hny main-cont-wthree-fea row mt-5">
                <div class="col-lg-4 col-md-6 grids-feature">
                    <div class="area-box">
                        ...
                        <p>Esta cuenta tiene un apalancamiento de 1:200</p>
                        <br><br><br>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 grids-feature mt-md-0 mt-4">
                    <div class="area-box">
                        ...
                        <p>Tu cuenta Standar te da Spreads desde 2.5 pips </p>
                        <br><br><br>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 grids-feature mt-lg-0 mt-4">
                    <div class="area-box">
                        ...
                        <p>Con tu cuenta Estandar podrás elegir entre cualquiera de nuestras plataformas.</p>
                        <br>
                        <br>
                        <br>
                    </div>
        ...
        <div class="container py-lg-5 py-md-3 py-2">
            <div class="row">
                ...
                <div class="col-lg-6 bottom-right-grids mt-lg-0 mt-5">
                    <img src="vistas/img/estandar1.png" alt="" width="100%" class="radius-image img-fluid">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-4 col-md-6 price-main-info mt-md-0 mt-4">
                    <div class="price-inner card box-shadow ">
                        <div class="card-body">
                            ...
                            <br>
                            <div class="read-more mt-lg-5 mt-4">
                                <!--<a href="registro" class="btn btn-text-white btn-primary btn-style btn-outline-primary">Aperturar Cuenta</a>-->
                                <a href="registro"      class="btn-cards"> Aperturar Cuenta</a>
                ...
                <div class="col-lg-4 col-md-6 price-main-info mt-lg-0 mt-4">
                    <div class="price-inner card box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="read-more mt-lg-5 mt-4">
                                <!-- <a href="registro" class="btn btn-style btn-text-white btn-primary btn-outline-primary">Aperturar Cuenta</a> -->
                                <a href="registro"      class="btn-cards"> Aperturar Cuenta</a>
    ...
    <div class="container py-md-5 py-sm-4 py-2">
        <div class="row">
            ...
            <div class="col-lg-3 align-self text-lg-right">
                <!-- <a href="cuentas-erc" class="btn btn-style btn-primary mt-lg-0 mt-md-5 mt-4 mr-2">Cuentas </a> -->
