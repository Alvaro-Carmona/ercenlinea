...
<section class="w3l-about-breadcrumb baner-azul">
    <div class="breadcrumb-bg breadcrumb-bg-services py-5">
        <div class="container py-lg-4 py-md-3">
            <h2 class="title">Cuenta Premium</h2>
            <ul class="breadcrumbs-custom-path">

                <!--   <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span> Cuenta premium</li>-->
            </ul>
        </div>
    </div>
</section>
    ...
    <div class="container py-lg-5 py-sm-4">
        <div class="maghny-gd-1">
            <div class="row about-text">
                <div class="col-lg-6">
                    <h3 class="title-big" style="font-family: Mulish; color:#3f3a64;">Conoce los beneficios que ERC tiene para ti en tu cuenta PREMIUM</h3>
                </div>
                <div class="col-lg-6 mt-lg-0 mt-4">
                    <p class="mb-3" style="font-size:18px;">Si tus operaciones conllevan menos tiempo en el mercado tendrás una comisión fija disminuyendo el spread incrementando la productividad de tu estrategia .</p>
            ...
            <div class="grids-area-hny main-cont-wthree-fea row mt-5">
                <div class="col-lg-4 col-md-6 grids-feature">
                    <div class="area-box">
                        ...
                        <h4><a href="#feature" class="title-head">Apalancamiento </a></h4>
                        <p>Tu cuenta premium te da Spreads desde 0.01 pips</p>
                        <br><br><br>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 grids-feature mt-md-0 mt-4">
                    <div class="area-box">
                        ...
                        <h4><a href="#feature" class="title-head">Spreads </a></h4>
                        <p>Tu cuenta Profesional te da Spreads desde 1.4 pips </p>
                        <br><br><br>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 grids-feature mt-lg-0 mt-4">
                    <div class="area-box">
                        ...
                        <h4><a href="#feature" class="title-head">Elige tu plataforma</a></h4>
                        <p>Con tu cuenta Premium podrás elegir entre cualquiera de nuestras plataformas.</p>
                        <br>
                        <br>
                        <br>
                    </div>
        ...
        <div class="container py-lg-5 py-md-3 py-2">
            <div class="row">
                ...
                <div class="col-lg-6 bottom-right-grids mt-lg-0 mt-5">
                    <img src="vistas/img/premium1.png" alt="" width="100%" class="radius-image img-fluid">
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="price-inner card box-shadow ">
                        <div class="card-body-premium">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                ...
                                <li><span class="fa fa-check" aria-hidden="true"></span>&nbsp;Analista financiero</li>
                                <li><span class="fa fa-check" aria-hidden="true"></span>&nbsp;Tarjeta de Débito Personalizada</li>
                                <li><span class="fa fa-check" aria-hidden="true"></span>&nbsp;Módulos de la Academia y Herramientas Complementarias</li>
                            </ul>
                            <br>
                            <div class="read-more mt-lg-5 mt-4">
                                <!-- <a href="registro" class="btn btn-style btn-outline-primary btn-text-white btn-primary">Aperturar Cuenta</a> -->
                    ...
                    <div class="price-inner card box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                ...
                                <li><span class="fa fa-check" aria-hidden="true"></span>&nbsp;Aprovecha 1:300</li>
                                <li><span class="fa fa-check" aria-hidden="true"></span>&nbsp;Se extiende desde 1.4 pips</li>
                                <li><span class="fa fa-check" aria-hidden="true"></span>&nbsp;Depósitos y retiros gratuitos</li>
                                <li><span class="fa fa-check" aria-hidden="true"></span>&nbsp;Tarjeta de Débito Básica</li>
                                <li><span class="fa fa-check" aria-hidden="true"></span>&nbsp;Módulos de la Academia y Herramientas Complementarias</li>
                                ...
                                <li><span class="fa fa-check" aria-hidden="true"></span>&nbsp;Aula Premium</li>
    ...
    <div class="container py-md-5 py-sm-4 py-2">
        <div class="row">
            ...
            <div class="col-lg-3 align-self text-lg-right">
               <!-- <a href="cuentas-erc" class="btn btn-style btn-text-white btn-primary mt-lg-0 mt-md-5 mt-4 mr-2">Cuentas </a> -->
